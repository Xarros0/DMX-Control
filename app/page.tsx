...
import { Control, Group, Light } from "./components/types/dmx";

// Local type for color/effect presets
type Preset =
        ...
        <div className="min-h-screen p-8 bg-gray-50">
          <div className="max-w-[100%] mx-auto grid grid-cols-12 gap-4">
            ...
            <GroupList
              ...
              addLightGlobal={addLightGlobal}
              updateLight={updateLight}
              deleteLightGlobal={deleteLightGlobal}
            ...
            <aside className="col-span-4">
              <div className="flex flex-col gap-4">
                ...
                <LightDetailPanel
                  ...
                  groupControlNames={groupControlNames}
                  setGroupControlValue={setGroupControlValue}
                  setGroups={setGroups}
                  updateLight={updateLight}
                  setSelectedScope={setSelectedScope}
                  sendToDmx={sendToDmx}
          ...
          <CreateLightModal
            ...
            groups={groups}
            name={modalName}
            dmxAddress={modalDmxAddress}
            controls={modalControls}
            groupId={modalGroupId}
            setName={setModalName}
            setDmxAddress={setModalDmxAddress}
            setGroupId={setModalGroupId}
            setControls={setModalControls}
            onCreate={createLightFromModal}
          />
